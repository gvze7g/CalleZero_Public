            ...
            <div className="max-w-6xl mx-auto px-6 py-16">
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-10 pb-12 border-b border-white/10">
                    <div className="max-w-xl">
                        ...
                        <p className="text-gray-400 text-sm md:text-base">
                            Acceso anticipado a drops exclusivos, eventos privados y 10% OFF
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-10 py-14">
                    <div className="col-span-2 md:col-span-1">
                        ...
                        >
                            <img src={logo} className="w-10 h-10" alt="Calle Zero" />
                        ...
                        <p className="text-gray-400 text-sm mb-5 leading-relaxed">
                            Estilo urbano minimalista para la generación que define su propio
                            camino.
                        </p>
